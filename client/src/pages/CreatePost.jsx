...
function CreatePost() {
  ...
  const handleSubmit = async () => {
    if(!images.length && !content){
      return toast.error("Please add at least one image or content")
    }
    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
          ...
          <div className='max-w-xl bg-white p-4 sm:p-8 sm:pb-8 rounded-xl shadow-md space-y-4 '>
              ...
              {/* Text Area */}
              <textarea className='w-full resize-none max-h-20 mt-4 text-sm outline-none placeholder-gray-400' name="" id="" placeholder="What's happening?" onChange={(e)=>setContent(e.target.value)} value={content}/>
              ...
              <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
                ...
                )} className='text-sm bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-500 hover:to-purple-600 active:scale-100 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer'>
                  Publish Post 
                </button>
              </div>
