        ...
        <div className='bg-white rounded-lg shadow p-6'>
            ...
            <form className='space-y-4' onSubmit={e=>toast.promise(
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label  htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                        Profile Picture
                        <input hidden type="file" value="" accept='image/*' id='profile_picture' 
                        ...
                        <div className='group relative'>
                            <img src={editForm.profile_picture ? URL.createObjectURL(editForm.profile_picture) : user.profile_picture} alt="" className='w-24 h-24 rounded-full object-cover mt-2'/>
                             ...
                             <div className="absolute hidden group-hover:flex top-0 right-0 left-0 bottom-0 bg-black/20 rounded-full items-center justify-center transition duration-300">
            ...
            <div className='flex flex-col items-start gap-3 '>
                <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                    Cover Photo
                    <input hidden type="file" value="" accept='image/*' id='cover_photo' 
            ...
            <div>
             ...
             <div>
                ...
                <input type="text" className='w-full p-3 border border-gray-200 rounded-lg ' placeholder='Enter your a username ' onChange={(e)=>setEditForm({...editForm,username:e.target.value})} value={editForm.username}/>
            </div>
             ...
             <div>
                ...
                <textarea rows={3}  className='w-full p-3 border border-gray-200 rounded-lg ' placeholder='Enter a short bio' onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio}/>
            </div>
